      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?php echo img_url('images_admin/images/'.$_SESSION['ADMIN']['info_personne']['image']) ?>" alt="User profile picture">

              <h3 class="profile-username text-center"><?php echo $_SESSION['ADMIN']['info_personne']['nom'].' '.$_SESSION['ADMIN']['info_personne']['prenom']  ?></h3>

              <p class="text-muted text-center"><?php echo $_SESSION['ADMIN']['info_personne']['telephone']['liste'][0].' <b>|</b> '.$_SESSION['ADMIN']['info_personne']['telephone']['liste'][0] ?></p>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>CLIENTS</b> <a class="pull-right"><?php echo $_SESSION['ADMIN']['clients'] ?></a>
                </li>

              </ul>

              <a href="<?php echo site_url(array('Administration','chargeFormulaireModifAdmin/'.$_SESSION['ADMIN']['id'])) ?>" class="btn btn-primary btn-block"><b>Modifier</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <br><br>
              <p class="text-muted">
                  <label>CNI : </label><?php echo $_SESSION['ADMIN']['info_personne']['cni'] ?>
              </p>

              <p class="text-muted">
                  <label>Email : </label><?php echo $_SESSION['ADMIN']['info_personne']['email'] ?>
              </p>

              <p class="text-muted">
                  <label>Sexe : </label><?php echo $_SESSION['ADMIN']['info_personne']['sexe'] ?>
              </p>

              <p class="text-muted">
                  <label>Login : </label><?php echo $_SESSION['ADMIN']['login'] ?>
              </p>
              ...
              <p class="text-muted"><?php echo $_SESSION['ADMIN']['info_personne']['adresse'] ?></p>
        ...
        <div class="col-md-9">
          ...
          <div class="tab-content">
            ...
            <div class="box-body">
              <img src="<?php echo img_url('images_admin/images/'.$_SESSION['ADMIN']['info_personne']['image']) ?>">
            </div>
           ...
           <div class="tab-content">
            ...
            <div class="box-body">
              <img src="<?php echo img_url('images_admin/images_cni/'.$_SESSION['ADMIN']['info_personne']['image_cni']) ?>">
            </div>
