  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       <div class="row">
        ...
        <!-- /.col -->
        <a href="<?php echo site_url(array('Administration','loadFormulaireAddAdmin')) ?>">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
    ...
    <div class="row" style="width: 95%;margin-left: 25px; margin-top: 30px;margin-bottom: 30px;">
      <form method="post" id="formulaire_filtre">
        <div class="row">
          <div class="col-md-2">
            <input class="form-control filtre_admin nom" type="text" placeholder="Filtre Nom">            
          </div>

          <div class="col-md-2">
            <input class="form-control filtre_admin prenom" type="text" placeholder="Filtre Prenom">            
          </div>

          <div class="col-md-2">
            <select class="form-control filtre_admin_select sexe">
          ...
          <div class="col-md-2">
            <input class="form-control filtre_admin cni" type="text" placeholder="Filtre CNI">            
          </div>

          <div class="col-md-2">
            <input class="form-control filtre_admin telephone" type="text" placeholder="Filtre Telephnone">            
          </div>
          <div class="col-md-2">
            <input class="form-control filtre_admin email" type="text" placeholder="Filtre Email">            
          </div>
        </div>
      </form>
    </div>
    ...
    <div class="row" id="div_liste_admin">
      ...
      <?php
       ...
       for ($i=($_SESSION['FILTER']['PAGE']*$_SESSION['FILTER']['NB_PAGE']); $i < $fin; $i++) {?>
          <a href="<?php echo site_url(array('Administration','viewAdminProfil/'.$data[$i]['id'])) ?>">
              <div class="col-md-4">
                ...
                <div class="box box-widget widget-user">
                  ...
                  <div class="widget-user-image">
                    <img class="img-circle" src="<?php echo img_url('images_admin/images/'.$data[$i]['info']['image']) ?>" alt="User Avatar">
                  </div>
      ...
      <div class="box-tools pull-right" style="margin-right: 20px;">
        <ul class="pagination pagination-sm inline">
          ...
          <?php if ($_SESSION['FILTER']['PAGE'] !=0) { ?>
            <li><a href="<?php echo site_url(array('Administration','pagination/admin/'.($_SESSION['FILTER']['PAGE'] -1))) ?>" >«</a></li>
          <?php } ?>

          <?php if ( (floor($data['total'] /$_SESSION['FILTER']['NB_PAGE']) +1) >= 1) { 
            for ($i=0; $i < (floor($data['total'] /$_SESSION['FILTER']['NB_PAGE'] ) +1) ; $i++) { 
          ?>
              <li><a href="<?php echo site_url(array('Administration','pagination/admin/'.$i)) ?>" <?php if ($i==$_SESSION['FILTER']['PAGE']) {?> style="background-color: #00a7d0 !important;color: white;" <?php } ?> ><?php echo $i+1 ?></a></li>
          <?php 
              }
            }
         ?>

         <?php if ( ($_SESSION['FILTER']['ADMIN']['total'] -$_SESSION['FILTER']['PAGE']*$_SESSION['FILTER']['NB_PAGE']) > $_SESSION['FILTER']['NB_PAGE']) {?>
          <li><a href="<?php echo site_url(array('Administration','pagination/admin/'.($_SESSION['FILTER']['PAGE'] +1))) ?>">»</a></li>
        <?php } ?>
        </ul>
      </div>
