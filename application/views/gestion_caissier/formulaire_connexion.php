...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="<?php echo site_url(array('Magazin','index')) ?>"><b>Magazin | </b>AM</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?php echo site_url(array('Caissier','manageConnexion')) ?>" method="post">
