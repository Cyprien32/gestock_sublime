  ...
  <div class="content-wrapper">
    ...
    <div class="row" style="width: 95%;margin-left: 25px; margin-top: 30px;margin-bottom: 30px;">
      <form method="post" id="formulaire_filtre">
        <div class="row">
          <div class="col-md-2">
            <input class="form-control filtre_client nom" type="text" placeholder="Filtre Nom">            
          </div>

          <div class="col-md-2">
            <input class="form-control filtre_client prenom" type="text" placeholder="Filtre Prenom">            
          </div>

          <div class="col-md-2">
            <select class="form-control filtre_client_select sexe">
          ...
          <div class="col-md-2">
            <input class="form-control filtre_client cni" type="text" placeholder="Filtre CNI">            
          </div>

          <div class="col-md-2">
            <input class="form-control filtre_client telephone" type="text" placeholder="Filtre Telephnone">            
          </div>
          <div class="col-md-2">
            <input class="form-control filtre_client email" type="text" placeholder="Filtre Email">            
          </div>
        </div>
      </form>
    </div>
    ...
    <div class="row" id="div_liste_client">
      ...
      for ($i=($_SESSION['FILTER']['PAGE']*$_SESSION['FILTER']['NB_PAGE']); $i <$fin; $i++) {?>
          <a href="<?php echo site_url(array('Administration','viewClientProfil/'.$data[$i]['id'])) ?>">
              <div class="col-md-4">
                <!-- Widget: user widget style 1 -->
                <div class="box box-widget widget-user">
                  <!-- Add the bg color to the header using any of the bg-* classes -->
                  <div class="widget-user-header bg-green-active color-palette">
                  ...
                  <div class="widget-user-image">
                    <img class="img-circle" src="<?php echo img_url('images_client/images/'.$data[$i]['info']['image']) ?>" alt="User Avatar">
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="description-block">
                          ...
                          <span class="description-text">ACHATS</span>
                        </div>
                        <!-- /.description-block -->
                      </div>
                      <!-- /.col -->
      ...
      <div class="box-tools pull-right" style="margin-right: 20px;">
        <ul class="pagination pagination-sm inline">
          ...
          <?php if ($_SESSION['FILTER']['PAGE'] !=0) { ?>
            <li><a href="<?php echo site_url(array('Administration','pagination/client/'.($_SESSION['FILTER']['PAGE'] -1))) ?>" >«</a></li>
          <?php } ?>

          <?php if ( (floor($data['total'] /$_SESSION['FILTER']['NB_PAGE']) +1) >= 1) { 
            for ($i=0; $i < (floor($data['total'] /$_SESSION['FILTER']['NB_PAGE'] ) +1) ; $i++) { 
          ?>
              <li><a href="<?php echo site_url(array('Administration','pagination/client/'.$i)) ?>" <?php if ($i==$_SESSION['FILTER']['PAGE']) {?> style="background-color: #00a7d0 !important;color: white;" <?php } ?> ><?php echo $i+1 ?></a></li>
          <?php 
              }
            }
         ?>

         <?php if ( ($_SESSION['FILTER']['CLIENT']['total'] -$_SESSION['FILTER']['PAGE']*$_SESSION['FILTER']['NB_PAGE']) > $_SESSION['FILTER']['NB_PAGE']) {?>
          <li><a href="<?php echo site_url(array('Administration','pagination/client/'.($_SESSION['FILTER']['PAGE'] +1))) ?>">»</a></li>
        <?php } ?>
        </ul>
      </div>
