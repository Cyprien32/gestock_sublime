      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="tab-content">
            ...
            <div class="box-body">
              <img src="<?php echo img_url('images_client/images/'.$data['CLIENT']['info_personne']['image']) ?>">
            </div>
           ...
           <div class="tab-content">
            ...
            <div class="box-body">
              <img src="<?php echo img_url('images_client/images_cni/'.$data['CLIENT']['info_personne']['image_cni']) ?>">
            </div>
